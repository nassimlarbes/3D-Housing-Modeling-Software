...
public class PignonG extends WallOfRoof {
    public PignonG(Chalet chalet, Toit toit) {
        super(chalet, toit);
    ...
    public String exportSTL() {
        if(this.chalet.isFrontIsPrincipal()){
            if(!this.chalet.isDirection_toit()){
                return toit.exportPignonArriereFront_gauche();
            }else{
                return toit.exportPignonFrontArriere_gauche();
            }
        }
        return "";
    }
    ...
    public String exportToBrut() {
        if(this.chalet.isFrontIsPrincipal()){
            if(!this.chalet.isDirection_toit()){
                return toit.exportPignonArriereFront_gauche_brut();
            }else{
                return toit.exportPignonFrontArriere_gauche_brut();
            }
        }
        return "";
    }
